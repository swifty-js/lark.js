...
const SECTIONS: HelpSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "The platform is built with larky (routing shell), Lit web components (UI), TailwindCSS, Monaco Editor, chart.js, and GSAP animations. It supports dark mode and responsive layouts.",
    ],
  },
];
