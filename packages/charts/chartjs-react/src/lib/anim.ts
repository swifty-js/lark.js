...
/**
 * Entrance choreography for lists/grids of children (gsap stagger).
 * Targets `data-anim` children of the root; safe to call repeatedly —
 * existing tweens on targets are overwritten.
 */
